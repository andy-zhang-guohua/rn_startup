...
import {SafeAreaView, SectionList, Slider, StyleSheet, TouchableWithoutFeedback,} from 'react-native';
...
export default class AnimatableExplorerView extends Component {
    state = {
        duration: 1000,
        toggledOn: false,
    };
